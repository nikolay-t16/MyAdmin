...
class Module {
	 ...
	 */
	protected static function GetModule($moduleName, $paramArray = array()) {
		if (!isset(self::$Modules[$moduleName])) {
			self::$Modules[$moduleName] = new module($moduleName, $paramArray);
		}
	 ...
	 */
	public static function StartModule($moduleName, $actionName = "index", $paramArray = array()) {
		return self::GetModule($moduleName)->Action($actionName, $paramArray);
	}
	/**
